...
package com.blade7777.cursedcraft.world.dimension;
...
import com.blade7777.cursedcraft.item.CursedDimensionItem;
import com.blade7777.cursedcraft.block.CursedBlackStoneBlock;
import com.blade7777.cursedcraft.CursedCraftModElements;

@CursedCraftModElements.ModElement.Tag
public class CursedDimensionDimension extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public CursedDimensionDimension(CursedCraftModElements instance) {
		super(instance, 42);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(CursedBlackStoneBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("cursed_craft:cursed_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("cursed_dimension_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("cursed_dimension_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("cursed_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new CursedDimensionItem().setRegistryName("cursed_dimension"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("cursed_craft:cursed_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("cursed_craft:cursed_dimension")));
				} else {
					entity.func_242279_ag();
