...
public class CursedBlanksBlock extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_blanks")
	public static final Block block = null;
	public CursedBlanksBlock(CursedCraftModElements instance) {
		super(instance, 11);
	}
