...
public class CursedStairsBlock extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_stairs")
	public static final Block block = null;
	public CursedStairsBlock(CursedCraftModElements instance) {
		super(instance, 12);
	}
