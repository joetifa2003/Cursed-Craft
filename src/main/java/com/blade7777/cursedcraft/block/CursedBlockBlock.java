...
public class CursedBlockBlock extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_block")
	public static final Block block = null;
	public CursedBlockBlock(CursedCraftModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(50f, 10f).setLightLevel(s -> 0));
			setRegistryName("cursed_block");
		}
