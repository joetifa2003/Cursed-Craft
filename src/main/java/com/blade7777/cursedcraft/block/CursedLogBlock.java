...
public class CursedLogBlock extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_log")
	public static final Block block = null;
	public CursedLogBlock(CursedCraftModElements instance) {
		super(instance, 9);
	}
