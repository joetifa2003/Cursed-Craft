...
public class CursedDirtBlock extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_dirt")
	public static final Block block = null;
	public CursedDirtBlock(CursedCraftModElements instance) {
		super(instance, 7);
	}
