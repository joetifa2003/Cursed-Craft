...
public class CursedStoneItem extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_stone")
	public static final Item block = null;
	public CursedStoneItem(CursedCraftModElements instance) {
		super(instance, 2);
	}
