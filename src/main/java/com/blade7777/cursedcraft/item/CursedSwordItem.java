...
public class CursedSwordItem extends CursedCraftModElements.ModElement {
	@ObjectHolder("cursed_craft:cursed_sword")
	public static final Item block = null;
	public CursedSwordItem(CursedCraftModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}, 3, -2.4f, new Item.Properties().group(CursedCraftItemGroup.tab)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public boolean hasEffect(ItemStack itemstack) {
				return true;
			}
		}.setRegistryName("cursed_sword"));
	}
}
